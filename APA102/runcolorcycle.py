...
def solid_color():
    ...
    MY_CYCLE = colorschemes.Amber(num_led=NUM_LED, pause_value=30,
...
def clock():
    ...
    MY_CYCLE = colorschemes.RoundAndRound(num_led=NUM_LED, pause_value=0,
                                          num_steps_per_cycle=NUM_LED, num_cycles=2) order = "rbg",
    MY_CYCLE.start()
...
def extra_demo():
    ...
    MY_CYCLE = colorschemes.StrandTest(num_led=NUM_LED, pause_value=0,
                                       num_steps_per_cycle=NUM_LED, num_cycles=3, order="rbg",
